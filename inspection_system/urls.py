...
urlpatterns = [
    ...
    path('view_reports/', inspector.views.view_reports, name='view_reports'),
    ...
    path('pattern_pred/<path:filename>', views.pattern_pred, name='pattern_pred'),
    ...
    # path('view_deficiency/', inspector.views.view_deficiency, name='view_deficiency'),
    ...
    # path('generate-report/', inspector.views.generate_report, name='generate_report'),
...
#     path('generate-report/', institute.views.generate_report, name='generate_report'),
# ]